...
# cat=Site Constants/general//; type=user[EXT:templavoila_framework/class.tx_templavoilaframework_pagelink.php:&tx_templavoilaframework_pagelink->main]; label=Unsubscribe Page ID: If no page ID is provided, the unsubscribe link will not be shown.
unsubscribePID =
